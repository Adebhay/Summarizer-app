// vertex-ai.js - Enhanced AI with emojis, bold headings, and hydration tracking
...
Here's your personalized coaching summary:

**📊 CONTEXT:**
• [1 sentence analyzing their browsing pattern - be specific]

**💡 INSIGHT:**
• [1 encouraging insight about their productivity]

**🎯 RECOMMENDATION:**
• [1 specific, actionable recommendation for tomorrow]
...
Important rules:
1. Use the bold headings (**) exactly as shown
2. Use the emojis (📊, 💡, 🎯, 💧, 🤔) exactly as shown
3. Keep each section short and specific
4. Do NOT include any copyright or footer text
...
function generateFallbackSummary(activityData) {
    ...
    if (totalMinutes < 30) {
        ...
        message = '⚖️ Good balance today! You spent about 1.5 hours online.';
